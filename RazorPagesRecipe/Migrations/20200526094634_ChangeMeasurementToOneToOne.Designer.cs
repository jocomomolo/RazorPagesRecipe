...
namespace RazorPagesRecipe.Migrations
{
    ...
    [Migration("20200526094634_ChangeMeasurementToOneToOne")]
    partial class ChangeMeasurementToOneToOne
    {
            ...
            modelBuilder.Entity("RazorPagesRecipe.Models.Measurement", b =>
                {
                    b.HasOne("RazorPagesRecipe.Models.Ingredient", "Ingredient")
                        .WithOne("Measurement")
                        .HasForeignKey("RazorPagesRecipe.Models.Measurement", "MeasurementID")
